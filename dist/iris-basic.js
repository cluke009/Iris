/*! Iris Color Picker - v1.0.6 - 2014-11-26
	...
	*/
	...
	Iris = {
		options: {
			...
			alphaSlider: false // show a slider for alpha channel
		},
		_color: '',
		_alpha: 1.0,
		...
		_addAlphaSlider: function() {
			...
			this.picker.find( '.iris-picker-inner' ).append(container);
		},
		_paint: function() {
			var self = this;
		...
		color: function(newColor) {
			if ( newColor === true ) {
				...
				return this._color.toCSS(this._color._alpha === 1.0 ? '' : 'rgba');
			}
